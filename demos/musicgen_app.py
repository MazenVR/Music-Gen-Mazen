...
def ui_full(launch_kwargs):
    ...
    button_primary_background_fill_hover="*primary_150"), title="Music Gen Mazen") as interface:
        gr.Markdown(
            """
            # MusicGen
        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    _ = gr.Button("Interrupt", variant="primary").click(fn=interrupt, queue=False)
                with gr.Row():
                ...
                with gr.Row():
                    ...
                    cfg_coef = gr.Number(label="CFG", value=3.0, interactive=True) #Classifier Free Guidance
            with gr.Column():
